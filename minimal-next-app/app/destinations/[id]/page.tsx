...
const destinationsData = {
  'fez': {
    ...
    description: 'Discover the ancient medina of Fez, a UNESCO World Heritage site and the world\'s largest car-free urban area. Famous for its traditional tanneries, medieval architecture, and vibrant souks.',
    location: {
      lat: 34.0181,
      lng: -5.0078,
    },
