...
import { MapPin, Calendar, Star, Download, Plane, Bus, Train, Car } from 'lucide-react'
    ...
    <div className="min-h-screen">
      ...
      <div className="container mx-auto py-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">Discover the best attractions and activities in this coastal paradise...</p>
        ...
        <section className="mb-16">
          ...
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-gray-600 mb-4">Discover the best of Essaouira with insider tips and local secrets...</p>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Button size="lg" className="w-full">Plan Your Journey</Button>
          <Button size="lg" className="w-full">Join the Discussion</Button>
          <Button size="lg" className="w-full">Read the Guide</Button>
          <Button size="lg" className="w-full">Book a Guide</Button>
        </section>
      </div>
    </div>
  )
