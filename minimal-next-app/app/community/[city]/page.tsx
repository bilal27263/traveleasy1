...
import { ThumbsUp, MessageCircle, Share2, UserPlus, Camera, X, TrendingUp, Hash, Users } from 'lucide-react'
...
const cityData = {
  ...
  'marrakech': {
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-chanwalrus-958545.jpg-b1rsTTRvfIQJyVdUZNYFLMLjmAJqFR.jpeg',
  ...
  'fes': {
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-furknsaglam-1596977-21529064.jpg-1z1HlfLuGJ6naj7bTR4xvgLriyXIUy.jpeg',
...
const cityImages = {
  'rabat': 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-droosmo-2958597.jpg-0wN2yd8XORBRR7FQDhwUtaawY8uYFC.jpeg',
  'casablanca': 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-gabriel-garcia-1263144-2404046.jpg-k9gqc7INAfIUKlZLPS635Y9PMz8OYV.jpeg',
  'marrakech': 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-chanwalrus-958545.jpg-b1rsTTRvfIQJyVdUZNYFLMLjmAJqFR.jpeg',
...
const mockComments: Comment[] = [
  {
    ...
    content: 'Make sure to visit the Hassan Tower and the Mausoleum of Mohammed V. They\'re stunning examples of Moroccan architecture!',
    likes: 15,
    replies: 3,
    createdAt: '2023-06-15T10:30:00Z',
    images: ['https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-gabriel-garcia-1263144-2404046.jpg-k9gqc7INAfIUKlZLPS635Y9PMz8OYV.jpeg']
  },
  {
    id: '2',
    author: 'Sarah',
    ...
    images: ['https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-chanwalrus-958545.jpg-b1rsTTRvfIQJyVdUZNYFLMLjmAJqFR.jpeg']
  },
  {
    id: '3',
    author: 'Youssef',
    ...
    content: 'For those interested in local culture, don\'t miss the traditional markets and the beautiful Majorelle Garden!',
    likes: 12,
    replies: 7,
    createdAt: '2023-06-13T09:15:00Z',
    images: ['https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-ekrulila-13794450.jpg-lrTqxkYGpd2A0pSNt7RMQUi8TAjiCF.jpeg']
  }
]
...
export default function CityDiscussionPage() {
  ...
  const cityDiscussions = relatedDiscussions[city as keyof typeof relatedDiscussions]
      ...
      <div className="relative h-[400px] rounded-xl overflow-hidden mb-8">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {city.charAt(0).toUpperCase() + city.slice(1)} Community
          </h1>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-500">
                        ...
                        <Button variant="ghost" size="sm">
                          <MessageCircle className="w-4 h-4 mr-1" /> {comment.replies}
                        </Button>
                        <Button variant="ghost" size="sm">
              ...
              <div className="space-y-4">
                {cityDiscussions?.map((discussion) => (
                  <div key={discussion.id} className="border-b last:border-0 pb-4 last:pb-0">
                    <h3 className="font-medium hover:text-orange-500 cursor-pointer">
                      {discussion.title}
                    </h3>
