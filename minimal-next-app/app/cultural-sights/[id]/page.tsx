...
const sightsData = {
  'hassan-ii-mosque': {
    ...
    description: 'One of the largest mosques in the world, featuring stunning Islamic architecture and oceanfront views.',
    rating: 4.9,
    reviewCount: 1250,
    activities: [
      {
  ...
  'ait-benhaddou': {
    name: 'Ait Benhaddou',
    location: 'Ouarzazate',
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/holidayme_10AmazingReasonsWhyYouShouldVisitMorocco_AitBenHaddou_shutterstock_414437029.jpg-NfCNfoDbEbPUPMHkSairQbnSZVsmdX.jpeg',
  ...
  'majorelle-garden': {
    ...
    location: 'Marrakech',
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-ekrulila-13794450.jpg-VeKSvdXJUP4rsN2o4o3tafiIDzKiSf.jpeg',
  ...
  'chouara-tannery': {
    ...
    location: 'Fez',
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-vlasceanu-19190883.jpg-KzSFjLFrUuPrp4dLIgxZoBGpFiPZdd.jpeg',
  ...
  if (!sight) {
    return (
      <div className="container mx-auto py-12 text-center">
        ...
        <Button onClick={() => router.push('/cultural-sights')}>
          Return to Cultural Sights
        </Button>
      </div>
    )
  }
                  ...
                  <Card key={activity.id} className="overflow-hidden">
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Button onClick={() => router.push(`/activities/${activity.id}/book`)}>
                          Book Now
                        </Button>
                      </div>
                    </CardContent>
