...
import { Gift, Search, Clock, MapPin, Star, Trophy, Users, Plane, Hotel, Briefcase } from 'lucide-react'
...
export default function WinTripPage() {
  ...
  const filteredContests = allContests.filter(contest => {
    ...
    const matchesDestination = selectedDestination === 'all' || contest.title.toLowerCase().includes(selectedDestination.toLowerCase())
    const matchesPrizeType = selectedPrizeType === 'all' || contest.category.toLowerCase() === selectedPrizeType.toLowerCase()
      ...
      <div className="container mx-auto py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {sponsors.map((sponsor) => (
              <div key={sponsor.id} className="bg-white rounded-lg shadow-md p-4 flex flex-col items-center justify-center">
                <Image
                  src={sponsor.logo}
                  alt={sponsor.name}
                  width={100}
        ...
        <section className="bg-orange-100 rounded-lg p-8 text-center">
          ...
          <p className="text-xl mb-6">Don't miss out on these amazing opportunities. Enter now and start your adventure!</p>
          <Button size="lg" className="bg-orange-500 hover:bg-orange-600">
