...
import { Star, Phone, Mail, Globe, Facebook, Twitter, Instagram, UserPlus, Bell, Heart, Share2, ChevronLeft, ChevronRight, MapPin, Award, Calendar } from 'lucide-react'
...
const agencyData = {
  ...
  description: 'Morocco Adventures is your gateway to experiencing the rich culture, stunning landscapes, and warm hospitality of Morocco. With over a decade of expertise, we craft unforgettable journeys that blend adventure, culture, and comfort.',
...
const galleryContent = [
  ...
  { id: '2', type: 'video', url: '/gallery/morocco-video-1.mp4', thumbnail: '/gallery/morocco-video-1-thumb.jpg', likes: 78, caption: 'Exploring the vibrant souks' },
  ...
  { id: '5', type: 'video', url: '/gallery/morocco-video-2.mp4', thumbnail: '/gallery/morocco-video-2-thumb.jpg', likes: 92, caption: 'Camel trek through the dunes' },
  { id: '6', type: 'image', url: '/gallery/morocco-4.jpg', likes: 41, caption: 'Ancient ruins of Volubilis' },
]

// Mock data for guides
const guides = [
  { id: '1', name: 'Hassan', image: '/guides/hassan.jpg', specialization: 'Cultural Expert', bio: 'With 15 years of experience, Hassan brings Morocco\'s rich history to life.' },
  { id: '2', name: 'Amina', image: '/guides/amina.jpg', specialization: 'Adventure Guide', bio: 'Amina leads our most thrilling desert and mountain expeditions.' },
  { id: '3', name: 'Youssef', image: '/guides/youssef.jpg', specialization: 'Culinary Specialist', bio: 'Youssef introduces travelers to the delicious world of Moroccan cuisine.' },
]

// Mock data for reviews
const reviews = [
  { id: '1', user: { name: 'Sarah T.', avatar: '/avatars/sarah.jpg' }, rating: 5, text: 'An unforgettable journey through Morocco. Every detail was perfect!' },
  { id: '2', user: { name: 'Michael R.', avatar: '/avatars/michael.jpg' }, rating: 4, text: 'Great mix of culture and adventure. Highly recommend the desert tour.' },
  { id: '3', user: { name: 'Emma L.', avatar: '/avatars/emma.jpg' }, rating: 5, text: 'Morocco Adventures made our family trip magical. The kids loved it!' },
]
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="flex items-center">
              ...
              <a href={`mailto:${agencyData.email}`} className="text-orange-500 hover:underline">{agencyData.email}</a>
            </div>
            <div className="flex items-center">
              <Globe className="h-5 w-5 text-gray-500 mr-2" />
              <a href={agencyData.website} target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">{agencyData.website}</a>
            </div>
            <div className="flex items-center space-x-4">
              <a href={agencyData.socialMedia.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-500">
                <Facebook className="h-5 w-5" />
              </a>
              <a href={agencyData.socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-500">
                <Twitter className="h-5 w-5" />
              </a>
              <a href={agencyData.socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-500">
        ...
        <section className="mb-12">
          ...
          <div className="text-center mt-6">
            <Button variant="outline" onClick={handleAddReview}>Write a Review</Button>
          </div>
        </section>
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    <li>Cancellation: Free cancellation up to 48 hours before the trip start date. After that, a 50% fee applies.</li>
                    <li>Refunds: Full refund for cancellations made more than 7 days before the trip. 50% refund for cancellations made 3-7 days before the trip.</li>
                    <li>Changes: One free date change allowed per booking, subject to availability.</li>
                    <li>Group Size: Minimum of 4 participants required for a trip to proceed. Maximum group size varies by tour.</li>
                  </ul>
                </CardContent>
              </Card>
            </TabsContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Discover the hidden gems and iconic locations that make Morocco a traveler's paradise.</p>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Essential tips and packing list for an unforgettable desert experience.</p>
                <Button variant="outline">Read More</Button>
              </CardContent>
            </Card>
          </div>
        ...
        <section className="bg-orange-100 rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button size="lg" onClick={() => console.log('Book Now clicked')}>Book Now</Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="hover:text-orange-500">Our Trips</Link></li>
                <li><Link href="#" className="hover:text-orange-500">FAQs</Link></li>
