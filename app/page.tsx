...
import { MapPin, Compass, Plane, ShoppingBag, ChevronRight, Search } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="relative h-screen flex items-center justify-center">
        ...
        >
          <source src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/3015519-hd_1920_1080_24fps-K4K1Qj67dFTBVJVSQz9E2i8u0NHCO1.mp4" type="video/mp4" />
        </video>
      ...
      <section className="py-16 bg-orange-50">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Discover the best travel agencies in Morocco and book your dream trip.</p>
      ...
      <section className="py-16 bg-orange-500 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="mb-8 max-w-2xl mx-auto">
            Let our expert travel agencies create the perfect Moroccan adventure for you.
            From desert expeditions to coastal retreats, we've got you covered.
          </p>
