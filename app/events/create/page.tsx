              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Your event will appear at the top of search results for your city.</p>
                  </div>
                  <Switch
                    id="featured"
            ...
            <Dialog>
              ...
              <DialogContent className="sm:max-w-[425px]">
                ...
                <div className="py-4">
                  ...
                  <p className="text-sm text-gray-500">{format(eventData.date || new Date(), "PPP")} at {eventData.time}</p>
                  <p className="text-sm text-gray-500">{eventData.location}</p>
                </div>
                <DialogFooter>
                  <Button type="submit" onClick={handleSubmit}>Publish Event</Button>
      ...
      <Card className="mt-8">
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            {eventData.price && (
              <p className="font-semibold">Price: ${eventData.price}</p>
            )}
            {eventData.capacity && (
              <p>Capacity: {eventData.capacity} attendees</p>
            )}
          </div>
        </CardContent>
      </Card>
