...
import { MapPin, Search, Star, CheckCircle2, Calendar, DollarSign, Camera, Home, Users, SlidersHorizontal, X } from 'lucide-react'
...
const guides = [
  {
    ...
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG-20231211-WA0009%20(1).jpg-S4WRlD8EUsG98Bn2H8h2c904ayPPIb.jpeg',
    location: 'Marrakech',
    category: 'Guide',
  ...
  },
  {
    ...
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG-20240919-WA0002.jpg-L2z6SmExqeOmFdTXcDAu2jHOiv1Gls.jpeg',
    location: 'Fes',
  ...
  },
  {
    ...
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-justin-shaifer-501272-1222271.jpg-IEgpsJWBfJA1FdnmOTSU6xXz1vhiIf.jpeg',
    location: 'Casablanca',
    category: 'Host',
  ...
  },
  {
    ...
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-italo-melo-881954-2379004.jpg-7EJ1kWaKfgOF8BcgKwt4yPbS2Wfodu.jpeg',
    location: 'Tangier',
    category: 'Guide',
  ...
  },
  {
    ...
    image: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-olly-733872.jpg-OZtJubvFos3j26MrC69wIsEpNwyjkk.jpeg',
    location: 'Rabat',
    category: 'Friend',
...
export default function GuidesPage() {
  ...
  const filteredGuides = guides.filter(guide => {
    ...
    return matchesSearch && matchesCategory && matchesLocation && matchesExperience &&
           matchesAvailability && matchesPrice && matchesRating && matchesVerified
  })
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-orange-50 py-12 mt-12">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Share your knowledge and earn while meeting people from around the world</p>
