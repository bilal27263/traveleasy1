...
const mockResults = {
  ...
  guides: [
    { id: 1, name: 'Mohammed', image: '/placeholder-guide.jpg', specialty: 'Photography', location: 'Rabat', rating: 4.7, reviews: 56 },
    { id: 2, name: 'Fatima', image: '/placeholder-guide.jpg', specialty: 'History', location: 'Fes', rating: 4.9, reviews: 78 },
  ],
  destinations: [
  ...
  events: [
    { id: 1, title: 'Fes Festival of World Sacred Music', image: '/placeholder-fes-festival.jpg', date: '2024-06-14', location: 'Fes' },
    { id: 2, title: 'Marrakech International Film Festival', image: '/placeholder-marrakech-festival.jpg', date: '2024-11-29', location: 'Marrakech' },
  ],
  community: [
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {results.guides.map((guide) => (
          <Card key={guide.id}>
            <CardContent className="p-4">
              ...
              <p className="text-gray-600 mb-2">{guide.specialty} in {guide.location}</p>
              <div className="flex items-center mb-2">
                <Star className="w-4 h-4 text-yellow-400 fill-current" />
        ...
        {results.destinations.map((destination) => (
          <Card key={destination.id}>
            <CardContent className="p-4">
              <Image src={destination.image} alt={destination.name} width={300} height={200} className="rounded-lg mb-4" />
        ...
        {results.community.map((post) => (
          <Card key={post.id}>
            <CardContent className="p-4">
              ...
              <p className="text-gray-600 mb-4">{post.replies} replies · {post.views} views</p>
