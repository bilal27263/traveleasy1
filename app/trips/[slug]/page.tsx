...
const relatedTrips = [
  { slug: "2", title: "Atlas Mountains Day Trip", image: "/trips/atlas-mountains.jpg", price: 89 },
  { slug: "3", title: "Essaouira Beach Getaway", image: "/trips/essaouira.jpg", price: 95 },
  { slug: "4", title: "Sahara Desert Adventure", image: "/trips/sahara-desert.jpg", price: 150 },
]
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          <div className="relative h-96 mb-4">
            <Image
              src={tripData.images[currentImageIndex] || "/placeholder.svg"}
              alt={tripData.title}
              layout="fill"
              objectFit="cover"
          ...
          <div className="flex items-center mb-6">
            ...
            <Link href={`/travel-agencies/${tripData.organizer.slug}`} className="flex items-center">
              <Image
                src={tripData.organizer.logo || "/placeholder.svg"}
