...
const tripData = {
  ...
  images: [
    '/trips/marrakech-1.jpg',
    '/trips/marrakech-2.jpg',
    '/trips/marrakech-3.jpg',
  ],
  rating: 4.8,
  reviewCount: 120,
  duration: '1 day',
  ...
  startDates: 'Daily',
  description: 'Explore the vibrant city of Marrakech on this full-day tour. Visit iconic landmarks, wander through the bustling souks, and immerse yourself in the rich culture and history of this ancient city.',
  price: 75,
  currency: 'USD',
  organizer: {
        ...
        <div>
          <Card>
            <CardContent className="p-6">
              ...
              <p className="text-3xl font-bold mb-6">{tripData.currency} {tripData.price} <span className="text-sm font-normal">per person</span></p>
