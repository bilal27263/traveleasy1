              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                  <CardContent className="p-6">
                    ...
                    <p className="text-gray-600 mb-4">Discover the must-do activities in the world's largest desert...</p>
          ...
          <div className="space-y-4">
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Join the discussion about the ideal seasons for desert exploration...</p>
