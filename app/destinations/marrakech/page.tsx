          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">Discover secret spots and local favorites in Marrakech's old city...</p>
                <Button variant="outline">Join Discussion</Button>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent className="p-6">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-4">Learn insider tips to navigate Marrakech like a pro and save money...</p>
