...
import { MapPin, Search, Calendar, DollarSign, Bookmark, Share2, Bus, Train, Plane, Hotel, Info, Download, Star } from 'lucide-react'
...
const destinations = [
  ...
  },
  {
    id: 'essaouira',
    name: 'Essaouira',
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-yuliya-kosolapova-1535772-3184563.jpg-ZdNK0KcVeUPvQeYtD4OkW4KlwFMRiz.jpeg",
  ...
  },
  {
    id: 'sahara',
    name: 'Sahara Desert',
    image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/pexels-salahkuro28-2960752.jpg-xczErBZ51AjXzBTuEStlpsdCpbQwHw.jpeg",
      ...
      <div className="relative h-[600px]">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-white">
          <h1 className="text-5xl font-bold mb-4 text-center">
            Discover Morocco: Where Every Journey Begins
          </h1>
      ...
      <div className="container mx-auto py-12">
              ...
              <Card key={attraction.id} className="overflow-hidden">
                ...
                <CardContent className="p-6">
                  ...
                  <Badge className="mt-4">
                    {attraction.activities} activities available
                  </Badge>
                </CardContent>
              </Card>
            ))}
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Your complete guide to navigating the Red City like a local.
                </p>
        ...
        <section className="bg-orange-50 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Subscribe to our newsletter for exclusive travel insights and deals
          </p>
