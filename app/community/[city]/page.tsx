...
import { ThumbsUp, MessageCircle, Share2, Camera, X, TrendingUp, Hash, Users } from "lucide-react"
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-4">
                          {comment.images.map((image, index) => (
                            <div key={index} className="relative aspect-video">
                              <Image src={image} alt={`Image ${index + 1}`} fill className="rounded-lg object-cover" />
                            </div>
                          ))}
                        </div>
                      )}
